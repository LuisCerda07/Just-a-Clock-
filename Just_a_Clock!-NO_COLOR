...
l_button = tk.Button(window, text = "", bg = "#5C5C5C", activebackground = "#363636", width= 17, bd = 5,) 
l_button.grid(row = 0, column = 0, sticky="w", padx = 59, pady = 20)

r_button = tk.Button(window, text = "", bg = "#5C5C5C", activebackground = "#363636", width= 17, bd = 5)
