...
l_button = tk.Button(window, text = "", bg = "#1c4966", activebackground = "#0e2433", width= 17, bd = 5,) 
l_button.grid(row = 0, column = 0, sticky="w", padx = 59, pady = 20)

r_button = tk.Button(window, text = "", bg = "#1c4966", activebackground = "#0e2433", width= 17, bd = 5)
